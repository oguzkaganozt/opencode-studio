...
import { falEndpoint, falJobStatus, falPlatformGet, falRequestID, formatToolJSON, requireFalKey } from "../src/fal"
...
describe("fal integration", () => {
  ...
  test("caps large tool output", () => {
    expect(formatToolJSON({ value: "x".repeat(100) }, 20)).toContain("truncated by opencode-media-studio")
  })
})
