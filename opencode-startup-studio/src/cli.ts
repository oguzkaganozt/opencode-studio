...
import { createStartupStudioApp } from "./server"
import { canonicalDataRoot } from "./studio-path"

const USAGE = `Usage:
  opencode-startup-studio install [--scope user|project] [--dry-run] [--json] [--config-home PATH] [--project-root PATH]
  opencode-startup-studio remove  [--scope user|project] [--dry-run] [--json] [--config-home PATH] [--project-root PATH]
  opencode-startup-studio doctor  [--scope user|project] [--json] [--config-home PATH] [--project-root PATH] [--root PATH] [--companion-url URL]
  opencode-startup-studio serve --root PATH [--host HOST] [--port PORT] [--ui-directory PATH]
...
async function serveCompanion(args: string[]) {
  ...
  try {
    ...
    const app = createStartupStudioApp({
      dataRoot,
      hostname,
      port,
