...
- Tools: `fw_workspace_list`, `fw_caps`, `fw_project_create`, `fw_project_read`, `fw_build`, `fw_sim_run`, `fw_sim_log`, `fw_spec`.
- After sim ok, `fw_spec` writes SPEC.json. Other studios read that file — never their design tools.
