...
Run as ``python -m cad_runtime._shape_op_subprocess <manifest.json> <out.json>``.
...
def _run(op: str, shapes: dict, params: dict) -> str:
    ...
    from cad_runtime.tools.inspect_part import _inspect_part_report
    from cad_runtime.tools.measure import _clearance_report, _measure_report
