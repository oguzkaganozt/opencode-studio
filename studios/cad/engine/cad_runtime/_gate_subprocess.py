...
Run as ``python -m cad_runtime._gate_subprocess <step_path>``. Loads the STEP,
...
def main() -> None:
    ...
    try:
        ...
        from cad_runtime.tools.validate import _EXACT_ISOLATED_MAX_TRIS, _mesh_defects_exact
