...
- **Select** — tap an existing region to select it (amber highlight; empty tap deselects). No draw. Selected **rect** shows HUD **W / H** (center-fixed edit → `size.quality=construction`). **Clear** removes all regions.
