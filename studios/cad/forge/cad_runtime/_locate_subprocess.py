...
Run as ``python -m cad_runtime._locate_subprocess <in.step> <out.json> [budget_s]``.
...
def _mesh_vertex_deflection_defects(shape, deadline: float | None = None) -> list:
    ...
    """
    from cad_runtime.tools.validate import _mesh_defects_exact
...
def _mesh_refined_untriangulated_faces(shape, deadline: float | None = None) -> list:
    ...
    from cad_runtime.tools.validate import (
