...
export function ErrorState({
  ...
  return (
    <div
      className={cn(
        "flex flex-col items-center justify-center rounded-[var(--osc-radius-lg)] border border-dashed border-[var(--osc-error)]/40 bg-[var(--osc-error-bg)] px-6 py-12 text-center",
        className,
      )}
      role="alert"
    >
