  ...
  return (moduleArg = {}) => {
    ...
    var FS = {
      ...
      createDefaultDevices() {
        FS.mkdir("/dev")
        FS.registerDevice(FS.makedev(1, 3), { read: () => 0, write: (_stream, _buffer, _offset, length, _pos) => length })
    ...
    var __embind_register_bigint = (_primitiveType, _name, _size, _minRange, _maxRange) => {}
    ...
    var __embind_register_bool = (rawType, name, trueValue, falseValue) => {
      ...
      registerType(rawType, {
        name,
        fromWireType: (wt) => !!wt,
        toWireType: (_destructors, o) => (o ? trueValue : falseValue),
    ...
    var EmValType = {
      ...
      toWireType: (_destructors, value) => Emval.toHandle(value),
      argPackAdvance: GenericWireTypeSize,
    ...
    var __embind_register_float = (rawType, name, size) => {
      ...
      registerType(rawType, {
        ...
        toWireType: (_destructors, value) => value,
        argPackAdvance: GenericWireTypeSize,
    ...
    var __embind_register_function = (name, argCount, rawArgTypesAddr, signature, rawInvoker, fn, isAsync, _isNonnullReturn) => {
    ...
    var __embind_register_integer = (primitiveType, name, size, minRange, maxRange) => {
      ...
      var checkAssertions = (_value, _toTypeName) => {}
      var toWireType
      if (isUnsignedType) {
        toWireType = function (_destructors, value) {
    ...
    var __embind_register_void = (rawType, name) => {
      ...
      registerType(rawType, {
        ...
        toWireType: (_destructors, _o) => undefined,
      })
    }
    ...
    var jstoi_q = (str) => parseInt(str, 10)
    var inetPton6 = (str) => {
      var words
      var w, offset, z
      var valid6regx =
    ...
    var wasmImports = {
      M: ___syscall_chmod,
      N: ___syscall_faccessat,
      h: ___syscall_fcntl64,
      I: ___syscall_fstat64,
      Q: ___syscall_ioctl,
      F: ___syscall_lstat64,
      G: ___syscall_newfstatat,
      j: ___syscall_openat,
      B: ___syscall_rmdir,
      H: ___syscall_stat64,
    ...
    var dynCall_viijii = (Module.dynCall_viijii = (a0, a1, a2, a3, a4, a5, a6) =>
      (dynCall_viijii = Module.dynCall_viijii = wasmExports.ha)(a0, a1, a2, a3, a4, a5, a6))
    var dynCall_viiiiji = (Module.dynCall_viiiiji = (a0, a1, a2, a3, a4, a5, a6, a7) =>
      (dynCall_viiiiji = Module.dynCall_viiiiji = wasmExports.ia)(a0, a1, a2, a3, a4, a5, a6, a7))
    var dynCall_jiji = (Module.dynCall_jiji = (a0, a1, a2, a3, a4) =>
      (dynCall_jiji = Module.dynCall_jiji = wasmExports.ja)(a0, a1, a2, a3, a4))
...
else if (typeof define === "function" && define.amd) define([], () => occtimportjs)
